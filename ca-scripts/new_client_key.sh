...
export CLIENT_KEY=${CLIENT_NAME}/client.key
export CLIENT_CSR=${CLIENT_NAME}/client.csr
export CLIENT_CRT=${CLIENT_NAME}/client.crt
...
${OQS_OPENSSL} x509 -req -in ${CLIENT_CSR} -out ${CLIENT_CRT} -CA ca.crt -CAkey ca.key -CAcreateserial -days $DAYS
